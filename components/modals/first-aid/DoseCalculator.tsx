...
import { KNOWN_INGREDIENTS } from './constants';
...
export const DoseCalculator: React.FC<DoseCalculatorProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6" id="first-aid-calculator-grid">
      ...
      <div className="lg:col-span-5 space-y-6">
        ...
        {matchedStoreProducts.length > 0 && (
          <div className="bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm space-y-3" id="first-aid-matched-shop-products">
            <div>
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-1.5 mt-0.5">
                          <span className="text-[11px] font-black font-mono text-slate-600">${prod.price.toFixed(2)}</span>
                          {isAdultMed && (
